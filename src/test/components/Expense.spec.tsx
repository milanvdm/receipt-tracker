...
test('Expense correctly follows the store state', () => {
    const receiptId = '1';
    const expenseId = '1'
...
test('Expense correctly fills in the form fields', () => {
    const receiptId = '1';
    const expenseId = '1'
...
test('Expense correctly handles price with `,` as delimiter', () => {
    const receiptId = '1';
    const expenseId = '1'
...
test('Expense correctly shows an error on a non-number price', () => {
    const receiptId = '1';
    const expenseId = '1'
    const expense: ExpenseData = { id: expenseId }
    const receipt: ReceiptData = { id: receiptId, category: 'food', expenses: Map({ [expenseId]: expense }) };
    ...
    const { getByText, getByPlaceholderText } = renderWithRedux(store, <Expense receiptId={receiptId} id={expenseId} />);
